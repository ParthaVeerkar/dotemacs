...
(setq live-welcome-messages
      (list (concat (live-user-first-name) ", may the source be with you; at your command, GNU Emacs is.")
            (concat (live-user-first-name) ", do or do not. There is no try.")
            (concat (live-user-first-name) ", don't criticize what you can't understand.")
            (concat (live-user-first-name) ", if you never try, you'll never know.")
